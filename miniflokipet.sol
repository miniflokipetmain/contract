...
pragma solidity ^0.6.12;
    ...
    contract MINIFLOKIPET is Context, IERC20, Ownable {
        ...
        string private _name = 'MINIFLOKIPET';
        string private _symbol = 'MINIFLOKIPET';
        ...
        uint256 private _buytaxFee = 6; 
        uint256 private _buystaketaxFee = 2; 
        uint256 private _buyMarketingPoolFee = 2;
        uint256 private _selltaxFee = 6; 
        uint256 private _sellstaketaxFee = 2; 
        uint256 private _sellMarketingPoolFee = 2;
        ...
        uint256 public walletlimit = 1000000000000 * 10**9;
        uint256 private _maxTxAmount = 1000000000000 * 10**9;
        // We will set a minimum amount of tokens to be swaped => 500K
        uint256 private _numOfTokensToExchangeForMarketingPool = 1000000 * 10**9;
    ...
    // List of front-runner & sniper bots f
        ...
        function _setsellTaxFee(uint256 selltaxFee) external onlyOwner() {
            require(selltaxFee >= 0 && selltaxFee <= 30, 'taxFee should be in 0 - 30');
        ...
        function _setsellstakeFee(uint256 sellstakeFee) external onlyOwner() {
            require(sellstakeFee >= 0 && sellstakeFee <= 30, 'stakeFee should be in 0 - 30');
        ...
        function _setsellMarketingPoolFee(uint256 sellMarketingPoolFee) external onlyOwner() {
            require(sellMarketingPoolFee >= 0 && sellMarketingPoolFee <= 99, 'MarketingPoolFee should be in 0 - 99');
